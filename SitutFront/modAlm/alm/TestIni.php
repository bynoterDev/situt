...
?>
	...
	<script type="text/javascript" src="../alm/js/validTest.js"></script>
	<script type="text/javascript" src="../alm/js/valTestC1.js"></script>
	<script type="text/javascript" src="../alm/js/testEdit1.js"></script>
<?php		
		} else {
