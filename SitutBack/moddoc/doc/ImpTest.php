...
?>
	...
	<div id="divd-1">
		<div id="divd-1b">
			...
			<label>Aspectos que usted observa en el alumno de forma evidente:</label>
			<br><br><br>
						<b><?php echo $dtest->opcion1; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->obesidad; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->delgadezExt; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->manchasPiel; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->faltaEnergia; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->problemDen; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->problemVis; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->problemAud; ?></b>	
			<b style="margin-left: 10px;"><?php echo $dtest->discapacidades; ?></b>
			<b style="margin-left: 10px;"><?php echo $dtest->otro; ?></b>
			<br><br><br>
